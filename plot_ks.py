...
def getArgs():
    ...
    parser.add_argument(
        '--resource', '-u',
        help='VISA resource string (auto-detect if not specified)',
        type=str,
        action='store',
        default=None
    )
    ...
    parser.add_argument(
        '--scale',
        help='Scale factor for display (e.g., 1000 for mA/mV)',
        action='store',
        type=float,
        default=1000,
    )
...
if __name__ == '__main__':
    a = getArgs()
    s = ks34460a.KS34460A(a.resource)
